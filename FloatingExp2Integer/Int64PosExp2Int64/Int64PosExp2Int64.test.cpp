...
namespace {
    ...
    TEST(DoubleExp2Int, ConstructorWorksWith_1) {
        floatingExp2Integer::Int64PosExp2Int64 num {1.0};
    ...
    TEST(DoubleExp2Int, ConstructorWorksWith_2) {
        floatingExp2Integer::Int64PosExp2Int64 num {2.0};
    ...
    TEST(DoubleExp2Int, OperatorPlusWorksWith_0_5and2) {
        floatingExp2Integer::Int64PosExp2Int64 num1 {0.5};
        floatingExp2Integer::Int64PosExp2Int64 num2 {2.0};
        ...
        floatingExp2Integer::Int64PosExp2Int64 result {num1 + num2};
    ...
    TEST(DoubleExp2Int, OperatorMultiplyWorksWith_0_5and2) {
        ...
        EXPECT_EQ(result.asDouble(), 1.0);
    }

    TEST(DoubleExp2Int, OperatorPlusWorksWith_6_345634and27_2728) {
        floatingExp2Integer::Int64PosExp2Int64 num1 {6.345634};
        floatingExp2Integer::Int64PosExp2Int64 num2 {27.2728};
        ...
        EXPECT_EQ(round_to(result.asDouble(), 0.00001), round_to(33.618434, 0.00001));
    }
}
