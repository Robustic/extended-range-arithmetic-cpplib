...
namespace {
    TEST(DoubleExp2Int, ConstructorWorksWith_1) {
        floatingExp2Integer::FloatExp2Int64 num {1.0};
    ...
    TEST(DoubleExp2Int, ConstructorWorksWith_2) {
        floatingExp2Integer::FloatExp2Int64 num {2.0};
    ...
    TEST(DoubleExp2Int, OperatorPlusWorksWith_0_5and2) {
        floatingExp2Integer::FloatExp2Int64 num1 {0.5};
        floatingExp2Integer::FloatExp2Int64 num2 {2.0};
        ...
        floatingExp2Integer::FloatExp2Int64 result {num1 + num2};
    ...
    TEST(DoubleExp2Int, OperatorPlusWorksWith_6_345634and27_2728) {
        floatingExp2Integer::FloatExp2Int64 num1 {6.345634};
        floatingExp2Integer::FloatExp2Int64 num2 {27.2728};
