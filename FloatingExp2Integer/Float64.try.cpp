...
void DoubleToFloat64ExtendedExpValues(std::vector<double>& doubleValues, 
    std::vector<floatingExp2Integer::Float64ExtendedExp>& float64ExtendedExpValues);
void DoubleToFukushimaValues(std::vector<double>& doubleValues, 
...
double sum_Float64ExtendedExp(std::vector<floatingExp2Integer::Float64ExtendedExp>& float64ExtendedExpValues, int64_t& time) {
    floatingExp2Integer::Timer timer;
    floatingExp2Integer::Float64ExtendedExp float64ExtendedExpValuesSum = float64ExtendedExpValues[0];
    for (unsigned int i = 1; i < float64ExtendedExpValues.size(); i++) {
        //std::cout << float64ExtendedExpValuesSum.asDouble() << " + " << float64ExtendedExpValues[i].asDouble() << " = ";
        float64ExtendedExpValuesSum += float64ExtendedExpValues[i];
        //std::cout << float64ExtendedExpValuesSum.asDouble() << std::endl;
    }
    timer.stop();
    time = timer.time();
    return float64ExtendedExpValuesSum.asDouble();
}

double sum_Fukushima(std::vector<floatingExp2Integer::Fukushima>& fukushimaValues, int64_t& time) {
    floatingExp2Integer::Timer timer;
    floatingExp2Integer::Fukushima fukushimaValuesSum = fukushimaValues[0];
    for (unsigned int i = 1; i < fukushimaValues.size(); i++) {
        //std::cout << float64ExtendedExpValuesSum.asDouble() << " + " << float64ExtendedExpValues[i].asDouble() << " = ";
        fukushimaValuesSum += fukushimaValues[i];
        //std::cout << float64ExtendedExpValuesSum.asDouble() << std::endl;
    }
    timer.stop();
    time = timer.time();
    return fukushimaValuesSum.asDouble();
}
...
void loop(int n, double results[], std::int64_t time[]) {
    ...
    std::vector<floatingExp2Integer::Float64ExtendedExp> float64ExtendedExpValues(n);
    std::vector<floatingExp2Integer::Fukushima> fukushimaValues(n);
    ...
    DoubleToFloat64ExtendedExpValues(doubleValues, float64ExtendedExpValues);
    DoubleToFukushimaValues(doubleValues, fukushimaValues);
    ...
    int64_t timer_Float64ExtendedExp;
    double float64ExtendedExpSum = sum_Float64ExtendedExp(float64ExtendedExpValues, timer_Float64ExtendedExp);

    int64_t timer_Fukushima;
    double fukushimaSum = sum_Fukushima(fukushimaValues, timer_Fukushima);
    ...
    std::cout << "Float64ExtendedExp sum:                 " << float64ExtendedExpSum << std::endl;
    std::cout << "fukushimaSum sum:                       " << fukushimaSum << std::endl;
    ...
    //results[16] = float64ExtendedExpSum;
    ...
    //time[16] = timer_Float64ExtendedExp;
    ...
    std::cout << "Float64ExtendedExp time:                  " << timer_Float64ExtendedExp << std::endl;
    std::cout << "Fukushima time:                           " << timer_Fukushima << std::endl;
    std::cout << std::endl;
}
...
std::int64_t calculate_avg_array_sum_dbl(std::string& header, int n, int n_rounds, const std::vector<double>& values, double& result)
{
...
std::int64_t calculate_avg_array_multiply_dbl(std::string& header, int n, int n_rounds, const std::vector<double>& values, double& result)
{
...
std::int64_t calculate_avg_sequential_sum_log2(std::string& header, int n, int n_rounds, const std::vector<double>& values, double& result)
{
...
std::int64_t calculate_avg_array_sum_log2(std::string& header, int n, int n_rounds, const std::vector<double>& values, double& result)
{
...
std::int64_t calculate_avg_sequential_sum_Dbl1(std::string& header, int n, int n_rounds, const std::vector<double>& values, double& result) 
{
    header = "Dbl1_sequential_sum:";

    std::vector<floatingExp2Integer::Dbl> values_converted(n);
...
std::int64_t calculate_avg_sequential_sum_Dbl2(std::string& header, unsigned int n, unsigned int n_rounds, const std::vector<double>& values, double& result)
{
    header = "Dbl2_sequential_sum:";

    std::vector<floatingExp2Integer::Dbl2> values_converted(n);
...
std::int64_t calculate_avg_array_sum_Dbl1(std::string& header, int n, int n_rounds, const std::vector<double>& values, double& result)
{
...
std::int64_t calculate_avg_array_sum_Dbl2(std::string& header, unsigned int n, unsigned int n_rounds, const std::vector<double>& values, double& result)
{
...
std::int64_t calculate_avg_sequential_multiply_Dbl1(std::string& header, int n, int n_rounds, const std::vector<double>& values, double& result)
{
...
std::int64_t calculate_avg_sequential_multiply_Dbl2(std::string& header, unsigned int n, unsigned int n_rounds, const std::vector<double>& values, double& result)
{
...
std::int64_t calculate_avg_array_multiply_Dbl1(std::string& header, int n, int n_rounds, const std::vector<double>& values, double& result)
{
...
std::int64_t calculate_avg_array_multiply_Dbl2(std::string& header, unsigned int n, unsigned int n_rounds, const std::vector<double>& values, double& result)
{
...
std::int64_t calculate_avg_array_sum_Float64PosExp2Int64(std::string& header, unsigned int n, unsigned int n_rounds, const std::vector<double>& values, double& result)
{
    header = "Float64PosExp2Int64_array_sum:";

    std::vector<floatingExp2Integer::Float64PosExp2Int64> values_converted(n);
...
std::int64_t calculate_array_sum_Fukushima(const std::vector<floatingExp2Integer::Fukushima>& values, double& result) {
    floatingExp2Integer::Timer timer;
    floatingExp2Integer::Fukushima sum(values);
    timer.stop();
    result = sum.asDouble();
    return timer.time();
}
...
std::int64_t calculate_avg_array_sum_Fukushima(std::string& header, unsigned int n, unsigned int n_rounds, const std::vector<double>& values, double& result)
{
    header = "Fukushima_array_sum:";

    std::vector<floatingExp2Integer::Fukushima> values_converted(n);
...
std::int64_t calculate_avg_sequential_sum_Fukushima(std::string& header, unsigned int n, unsigned int n_rounds, const std::vector<double>& values, double& result)
{
...
std::int64_t calculate_avg_array_sum_Float64ExtendedExp(std::string& header, unsigned int n, unsigned int n_rounds, const std::vector<double>& values, double& result)
{
    ...
    std::int64_t time_sum = 0.0;
    for (unsigned int i = 0; i < n_rounds; i++) {
        time_sum += calculate_array_sum_Float64ExtendedExp(n, values_converted, result);
    }
...
int main() {
    ...
    for (unsigned int i = 0; i < n_count; i++) {
        ...
        for (unsigned int f = 0; f < functions.size(); f++) {
            std::function<std::int64_t(std::string&, int, int, const std::vector<double>&, double&)> function = functions[f];
            std::string header;
            double result;
            std::int64_t time = function(header, n_current, n_rounds_current, double_values, result);
