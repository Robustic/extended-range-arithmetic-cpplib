...
int main() {
    ...
    Log2ToFloat32Exp2Int32Values(log2Values, float32Exp2Int32Values);
    ...
    std::cout << "Float32Exp2Int32 time:    " << duration3.count() << std::endl;
    std::cout << std::endl;

    std::cout << "Float32Exp2Int32 time / Log2 time " << (float)duration3.count() / (float)duration2.count() << std::endl;
    std::cout << "Log2 time / Float32Exp2Int32 time " << (float)duration2.count() / (float)duration3.count() << std::endl;
}
